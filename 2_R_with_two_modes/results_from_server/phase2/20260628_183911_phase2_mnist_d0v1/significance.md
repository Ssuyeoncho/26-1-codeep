...
|---|---:|---:|:---:|---:|---:|---|
| dmsr_laplace_b0.5 | 1 | 64.71 | ✗ | nan | nan | seed 부족 (paired 검정에는 num_seeds≥2 필요) |
| dmsr_normal_s0.3 | 1 | 441.6 | ✗ | nan | nan | seed 부족 (paired 검정에는 num_seeds≥2 필요) |
| dmsr_normal_s0.8 | 1 | 112.7 | ✗ | nan | nan | seed 부족 (paired 검정에는 num_seeds≥2 필요) |
| dmsr_normal_s1.5 | 1 | 66.9 | ✗ | nan | nan | seed 부족 (paired 검정에는 num_seeds≥2 필요) |
| hang_laplace_b0.5 | 1 | 75.55 | ✗ | nan | nan | seed 부족 (paired 검정에는 num_seeds≥2 필요) |
